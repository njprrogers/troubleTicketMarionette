...
require.config({
    ...
    paths: {
        ...
        'backbone.marionette': '../bower_components/backbone.marionette/lib/core/amd/backbone.marionette1',
...
//        'bootstrap-button': 'vendor/bootstrap-button',
    ...
    deps: ['backbone', 'config'].concat(tests),
    callback: window._karma__.start
});